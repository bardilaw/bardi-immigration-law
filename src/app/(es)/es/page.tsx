...
export const metadata: Metadata = {
  ...
  description:
    'Comprometidos con su camino migratorio, enfocados en su futuro. Bardi Immigration Law brinda orientación experimentada y defensa dedicada en defensa contra la deportación, inmigración familiar, perdones, alivio humanitario y litigios federales.',
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Bardi Immigration Law — Comprometidos con Su Camino Migratorio',
      },
    ],
    title: 'Bardi Immigration Law | Comprometidos con Su Camino Migratorio',
    description:
      'Comprometidos con su camino migratorio, enfocados en su futuro. Orientación experimentada y defensa dedicada de principio a fin.',
...
const DIFFERENTIATORS = [
  {
    label: 'Orientación Experta, Defensa de Confianza',
    desc: 'Representación experimentada en defensa contra la deportación, inmigración familiar, perdones (waivers), alivio humanitario y litigios federales.',
  },
  {
    label: 'Planes de Pago Flexibles',
    desc: 'Trabajamos según sus necesidades específicas y ofrecemos planes de pago, para que el costo no sea una barrera para una representación sólida.',
  },
  {
    label: 'Sirviendo al Área Metropolitana de Atlanta y Más Allá',
    desc: 'Con sede en el área metropolitana de Atlanta, representamos a clientes en Georgia y Alabama, y en asuntos federales en todo el país.',
  },
];
  ...
  return (
    <>
      ...
      <main id="main-content">
          ...
          <div className="relative max-w-site mx-auto px-5 lg:px-8 py-20 lg:py-32">
            <div className="text-center lg:text-left lg:max-w-[50%]">
              ...
              <p className="text-lg text-charcoal/80 mb-8 max-w-prose mx-auto lg:mx-0">
                Ya sea que busque reunir a su familia, defenderse contra la deportación o solicitar
                alivio humanitario, Bardi Immigration Law le brinda orientación experimentada y
                defensa dedicada de principio a fin. Nos importa su futuro y estamos comprometidas a
        ...
        <section className="bg-warmgray py-16">
          <div className="max-w-site mx-auto px-5 lg:px-8 text-center">
            ...
            <p className="text-lg text-charcoal/70 max-w-2xl mx-auto">
              Pronto compartiremos testimonios de los clientes y las familias que hemos acompañado.
            </p>
          </div>
        </section>
        ...
        <section className="bg-warmgray py-16">
          <div className="max-w-site mx-auto px-5 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="font-serif text-xl text-charcoal/70 mb-6">Orientación experta. Defensa de confianza. A su lado.</p>
              <p className="text-charcoal/80 mb-6">
                Desde su primera conversación hasta el resultado final, le brindamos orientación con
                conocimiento y defensa dedicada, y usted siempre sabe exactamente en qué etapa está
                su caso.
              </p>
        ...
        <section className="bg-white py-16">
          <div className="max-w-site mx-auto px-5 lg:px-8 text-center">
            <h2 className="font-serif text-3xl lg:text-4xl font-bold text-navy mb-10">¿Por Qué Elegir a Bardi Law?</h2>
          ...
          <div className="max-w-site mx-auto px-5 lg:px-8 grid lg:grid-cols-[40%_60%] gap-16 items-center">
            ...
            <div>
              ...
              <p className="font-sans text-base text-charcoal leading-[1.65] mt-3">
                Eszter Bardi representa a personas y familias en algunas de las áreas más difíciles de la ley de inmigración de EE.UU., con orientación experimentada y defensa dedicada en cada etapa de su caso.
              </p>
              <a
                href="/es/about"
