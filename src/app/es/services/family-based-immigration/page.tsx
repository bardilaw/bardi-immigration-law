...
export const metadata: Metadata = {
  title: 'Abogada Inmigración Familiar | Tarjetas Verdes y Peticiones Familiares',
  description:
    'Tarjetas verdes familiares, peticiones I-130, naturalización y ajuste de estatus. Como la ley de inmigración es federal, representamos a clientes en todo el país. Representación directa de la abogada desde la petición hasta la aprobación.',
  alternates: {
    canonical: 'https://bardilaw.com/es/services/family-based-immigration',
    languages: {
      'x-default': 'https://bardilaw.com/services/family-based-immigration',
  ...
  openGraph: {
    ...
    title: 'Inmigración Familiar | Bardi Immigration Law',
    description: 'Peticiones I-130, tarjetas verdes, ajuste de estatus y naturalización.',
